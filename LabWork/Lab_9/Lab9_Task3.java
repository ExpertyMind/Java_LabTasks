...
class Perc{
    ...
    public static void showPerc(){
        for (int i = 0; i < Lab9_Task1.Info.size() - 1; i++) {

            System.out.print("Name: " + Lab9_Task2.Names.get(i) + ", " + "Roll: " + Lab9_Task2.Roll_No.get(i) + ", " + "Percentage: " + String.format("%.2f", Percentages.get(i)) + "%, " + "Grade: " + Grade(Percentages.get(i)));
            System.out.println();
        }
    }
